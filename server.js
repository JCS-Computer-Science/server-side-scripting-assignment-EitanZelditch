...
server.get('/newgame', (req, res) => {
    let wordToGuess = req.query.answer || "ashes"
    let newID = uuid.v4()
    let newgame = {
...
server.get('/gamestate', (req, res) => {
    ...
    if(!gameState.gameOver){
        gameState.wordToGuess = "Ashes"
    }
    let responseState = {
        wordToGuess: gameState.gameOver ? gameState.wordToGuess: "Ashes",
 ...
 server.post('/guess', (req, res) => {
    ...
    res.status(201).send({
        ...
        gameState: {
            wordToGuess: game.gameOver ? game.wordToGuess : "ashes",
            guesses: game.guesses,
            wrongLetters: game.wrongLetters,
            closeLetters: game.closeLetters,
            rightLetters: game.rightLetters,
